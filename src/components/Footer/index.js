...
const Footer = () => (
  ...
  <ColT style={{display: 'flex', justifyContent: 'center'}}>
    <Title>
      <Link href="https://omgswap.com/" target="_blank">
  ...
  <ColS style={{display: 'flex', justifyContent: 'center'}}>
    ©  2020 All rights reserved by Ǒmega
  </ColS>
  <ColT style={{display: 'flex', justifyContent: 'center'}}>
  <Title>
    ...
    <Link href="https://www.facebook.com/omegadefi" target="_blank">
      <h1 id="title">
    ...
    <Link href="https://www.reddit.com/u/omegadefi/" target="_blank">
      <h1 id="title">
