...
function OverviewList({ currencyUnit, history }) {
  ...
  const TransactionItem = ({ exchange, id }) => {
    if (exchange.tokenAddress === '0x9043d4d51C9d2e31e3F169de4551E416970c27Ef') {
      exchange.tokenSymbol = 'pDAI'
    }
    if (exchange.tokenAddress === '0xF4c17Bc4979c1dc7b4CA50115358Dec58C67fD9d') {
      exchange.tokenSymbol = 'OPM'
      exchange.tokenName = 'Omega Protocol Money'
    }
    return (
      <DashGridClickable
        style={{ height: '60px' }}
